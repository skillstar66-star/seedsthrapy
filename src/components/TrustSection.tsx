            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex-shrink-0 w-64 sm:w-72 text-center p-4 sm:p-6 rounded-2xl bg-surface border border-soft-green/40 hover:border-secondary/20 transition-all duration-300 shadow-card hover:shadow-card-hover snap-start flex flex-col items-center justify-center gap-3"
                >
